            ...
            <div id="dashboard-ui-elements">
                <header id="dashboard-header" style="background-size: cover; background-position: center;">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h2 id="dashboard-title" class="font-bold text-white"></h2>
                            <p id="dashboard-subtitle" class="text-gray-300"></p>
                        </div>
                    </div>
                </header>
                
                <div id="dashboard-operation-modes" class="flex justify-center items-center gap-4">
                    <!-- Operation mode lights will be generated by JS -->
                </div>
            </div>
            
            <!-- Main Dashboard Content -->
            <div class="dashboard-main-content active">
                <!-- Chart Container -->
